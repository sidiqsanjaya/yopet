        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form action="?page=signin" method= "POST" class="bg-white">
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input class="pl-2 outline-none border-none" type="text" name="inputusermail" id="" <?php if(isset($_POST['inputusermail']) == true){echo 'value="'.$_POST['inputusermail'].'"';} ?>placeholder="Username or Email" />
                </div>
